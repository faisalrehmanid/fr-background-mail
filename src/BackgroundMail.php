...
class BackgroundMail
{
    ...
    public function __construct(array $config)
    {
        ...
        if (
            !is_int($number_of_retry_for_send_mail) ||
        ...
        if (
            !is_int($number_of_send_mail_workers_for_background_job) ||
     ...
     *      [
     *       // SMTP details for authenticated email. If provided it will be used otherwise system configured send mail will be used to send emails
     *       "smtp_json" => '{"host":"smtp.office365.com","port":"587","encryption":"tls","username":"from1@email.com","password":"your-smtp-password"}',
     * 
     ...
     *       "from" => "from1@email.com: From 1; from2@email.com;",
     * 
     *       // Sender is optional but if from is multiple it must be single email address indicate who physically sent the message
     *       "sender" => "from1@email.com: From 1",
     *       
     *       // Return path specifies where bounse notification should be sent.
     *       // It is optional but when given it must be single valid email address and not include a personal name
     *       "return_path" => "from2@email.com",
     * 
     ...
     *       "to" => "to1@email.com: To1; to2@email.com;",
     * 
     *       // Reply to is optional. Can be multiple emails separated by ;  
     *       "reply_to" => "reply-to1@email.com: Reply To1; reply-to2@email.com",
     *    
     *       // CC is optional. Can be multiple emails separated by ;  
     *       "cc" => "cc1@email.com: CC1; cc2@email.com;",
     * 
     *       // BCC is optional. Can be multiple emails separated by ;  
     *       "bcc" => "bcc1@email.com: BCC1; bcc2@email.com;",
     * 
     ...
     *       "attachment_1_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-1.txt","name":"attachment-1.txt"}',
     *       "attachment_2_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-2.txt","name":"attachment-2.txt"}',
     *       "attachment_3_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-3.txt","name":"attachment-3.txt"}',
     *       "attachment_4_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-4.txt","name":"attachment-4.txt"}',
     *       "attachment_5_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-5.txt","name":"attachment-5.txt"}',
     *       "attachment_6_json" => '{"path":"https:\/\/test.com\/sample-attachments\/attachment-5.txt","name":"attachment-6.txt"}',
     *      ],
     * ]
